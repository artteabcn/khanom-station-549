# Khanom Station 549 — Project Resume

Last updated: 2026-05-11 (v2)

A boutique B&B website for Khanom Station 549 (Khanom). Marketing site
...
- Root layout: `metadataBase`, `themeColor: #0d6b6b`, icons, robots
  defaults.
...
- **Stripe go-live checklist** (integration shipped 2026-05-09, switched
  ...
  - Register webhook in Stripe Dashboard pointing to
    `https://khanom-station-549.com/api/stripe/webhook` for events
...
- **Search Console** — submit sitemap at `https://khanom-station-549.com/sitemap.xml`
...
- **Resend domain verification** — confirm `khanom-station-549.com` is
...
- **Auth:** Cloudflare Access at the edge — emails `greg@arkadya.tech`,
  `bradley@arkadya.tech`, `khanomstation549.lamai@gmail.com`. Configured once in
...
- **R2:** `khanomstation549-media` bucket bound as `MEDIA`. Public URL set in
...
- **Setup steps for go-live** (see CLAUDE.md → "CMS / Admin Panel"):
  ...
  - `wrangler r2 bucket create khanomstation549-media` + enable public access
